...
let a = getRequest("GET", requestURL)
  .then((data) => {
    ...
    for (let key in request) {
      ...
      let value = request[key].Value;

      let currencyInfo = document.createElement("div");
      currencyInfo.className = "data-info";

      // currencyInfo.addclassName = 'data-info'
      ...
      // `<div class="data-info">
      //     <span class="data__currency">${request[key].CharCode}</span>
      //     <span class="data__value">${value.toFixed(2)}</span>
